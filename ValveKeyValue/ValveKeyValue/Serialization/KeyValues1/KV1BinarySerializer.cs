...
namespace ValveKeyValue.Serialization.KeyValues1
{
    sealed class KV1BinarySerializer : IVisitationListener, IDisposable
    {
        ...
        static KV1BinaryNodeType GetNodeType(KVValueType type)
        {
            switch (type)
            {
                case KVValueType.FloatingPoint: return KV1BinaryNodeType.Float32;
                case KVValueType.Int32: return KV1BinaryNodeType.Int32;
                case KVValueType.Pointer: return KV1BinaryNodeType.Pointer;
                case KVValueType.String: return KV1BinaryNodeType.String;
                case KVValueType.UInt64: return KV1BinaryNodeType.UInt64;
                case KVValueType.Int64: return KV1BinaryNodeType.Int64;
                default: throw new ArgumentOutOfRangeException(nameof(type), type, "Unhandled value type.");
            }
        }
    }
}
